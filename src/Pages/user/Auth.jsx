...
<div className='min-h-screen w-full px-5 max-sm:pt-50 md:grid md:grid-cols-[2fr_3fr_2fr] items-center'>
  ...
  <div className='shadow-2xl space-y-5 px-10 md:px-55 rounded-xl min-h-fit py-10 w-full'>
    <div className='flex justify-center'>
      <div className='text-5xl text-[#00A896]'><FaUser /></div>
    </div>

    <div className='flex justify-center'>
      <h1 className='text-xl font-medium text-gray-800'>{login ? "Login" : "Register"}</h1>
    </div>

    {/* Full Name */}
    {!login && (
      <div className='flex flex-col justify-center'>
        <input type="text" className='shadow-inner bg-white border border-gray-300 outline-none rounded px-3 py-2' placeholder='Enter Full Name' />
      </div>
    )}
    ...
    <div className='flex flex-col justify-center'>
      <input
        type="text"
        className='shadow-inner bg-white border border-gray-300 outline-none rounded px-3 py-2'
        placeholder={login ? 'Enter Email/Username' : 'Enter Email'}
      />
    </div>
    ...
    {/* Password */}
    <div className='flex flex-col justify-center'>
      <input type="password" className='shadow-inner bg-white border border-gray-300 outline-none rounded px-3 py-2' placeholder='Enter Password' />
    </div>

    {/* Phone Number */}
    {!login && (
      <div className='flex flex-col justify-center'>
        <input type="text" className='shadow-inner bg-white border border-gray-300 outline-none rounded px-3 py-2' placeholder='Enter Phone Number' />
      </div>
    )}

    {/* Action Button */}
    <div className='flex justify-center'>
      <button className='bg-[#00A896] text-white px-4 py-2 rounded hover:bg-[#00C9B1] transition-colors duration-300'>
        {login ? "Login" : "Register"}
      </button>
    </div>
